...
class ArticleCard extends StatelessWidget {
  ...
  final Function(Article) onMarkAsRead;

  const ArticleCard(
      {super.key, required this.article, required this.onMarkAsRead});
  ...
  Widget build(BuildContext context) {
    return Dismissible(
      ...
      background: Container(
        color: article.read == true ? Colors.green : Colors.red,
        alignment: Alignment.centerRight,
        padding: const EdgeInsets.only(right: 16.0),
        child: article.read == true
